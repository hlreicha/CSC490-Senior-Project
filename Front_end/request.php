...
function insertRequest($requestTimeStamp){
	...
	$sql = "SELECT * FROM RequestOff WHERE Employee_ID = $empID and Day = $requestTimeStamp";
	$sql1 = "INSERT INTO RequestOff (Employee_ID,Schedule_Id, Day, Reason) VALUES ($empID, $schedID, $requestTimeStamp, 'hey man')";
