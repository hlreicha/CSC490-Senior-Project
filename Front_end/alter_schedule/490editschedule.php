...
<!--start top of page-->
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container box">
            ...
            <h1 class="jumbomessage display-1 text-success font-weight-bold">Edit Schedule</h1>
        </div>
    </div>
<!--end top of page-->
        ...
        <div class="col-12 bg-dark text-light">
			<br />
                ...
                <input class="form-control" input type="number" type="text" placeholder="By Employee ID" aria-label="Search" id="Employee_ID1" name="Employee_ID1">
                <br />
 ...
 $(document).ready(function(){  
      ...
      $('#action').click(function(){  
           ...
           if(Scheduled_Start != '' && Scheduled_End != '' && Employee_ID != '' && Position != '')  
           {  
